            ...
            <div class="content">
                <form id="movie-form" action="MovieController">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="rating" name="rating" step="0.1" min="0" max="10" value="${movie.note}" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="platform" name="platform" value="${movie.plataform}" required>
                    </div>
